...
set DEFAULT_JVM_OPTS="--module-path" "APP_HOME_LIBS_PLACEHOLDER" "--module" "com.unina.project/com.unina.project.Main"
...
@rem Execute Project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module com.unina.project/com.unina.project.Main %*
